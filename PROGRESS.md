...
| 3.6 | 期末汇报材料 | 🔄 收口中 | 以 `项目展示.html` 为主答辩材料，PPT 仅保留备份角色 |
| 3.7 | 项目展示网页 | ✅ 完成并升级中 | gh-pages（独立 HTML，正向答辩主舞台强化） |
...
→ 完成 HTML 主讲页统摄升级 → 补齐第 21-32 次课课程产物入口 → 准备 `v1.1` Release
...
## 2026-06-03 第十四周最高完成度补齐

| # | 事项 | 产出 |
|---|---|---|
| 14.5 | 课堂进度矩阵补齐 | `docs/课堂进度对照矩阵.md`，逐项映射第 21-32 次课要求 |
| 14.6 | 引用库与 AI 伦理透明化 | `docs/引用库与AI伦理说明.md` |
| 14.7 | 智能体工作流沉淀 | `docs/智能体工作流总览.md` |
| 14.8 | 写作改写轨迹整理 | `docs/写作修订日志.md` |
| 14.9 | 预答辩与 PR review 准备 | `docs/预答辩与PR-Review准备包.md` |
| 14.10 | 终版归档入口建立 | `docs/终版归档说明.md` |
| 14.11 | HTML 主讲强化 | 新增总论点、证据链、里程碑文献、技术路线等统摄页；关键结果页补 takeaway |
| 14.12 | 对外叙事统一 | README、Release 草案、HTML 页脚与课程文档同步为答辩收口版本 |
