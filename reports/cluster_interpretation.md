...
> 生成时间：2026-05-08 | 更新：2026-05-08（补充 MPY 指标）
> 方法：L19 课件要求（时间线图+时段对比+学科品性 overlay）
> 数据来源：DL 纯净集 147 篇（CiteSpace + Python），全量集 643 篇（国家/机构分布统计）
...
| 聚类 | 标签（LLR） | 起始年 | MPY（平均出版年） | 活跃时段 | 2025 状态 | 解读 |
|------|------------|--------|------------------|----------|-----------|------|
| #0 | machine learning | 2020 | ~2023（偏新/红色） | 2020-2025 | 活跃 | AI 方法聚类，MPY 偏新，持续活跃 |
| #1 | annotation | 2021 | ~2023（偏新/红色） | 2021-2025 | 活跃 | 数据标注方向，ViT 带动，MPY 新 |
| #2 | defect detection | 2021 | ~2022（偏新/红色） | 2021-2025 | 活跃 | 核心应用场景，MPY 中新 |
| #3 | wafer map | 2022 | ~2024（最新/深红） | 2022-2025 | 活跃 | 晶圆图分析，MPY 最新，2022 起加速 |
| #4 | inductors | 2015 | ~2018（偏旧/蓝色） | 2015-2022 | **死亡** | 传统硬件聚类，MPY 偏旧，2022 后无新论文 |
| #8 | cnn | 2020 | ~2021（中等/浅红） | 2020-2025 | 活跃 | CNN 仍在使用，MPY 中等，Transformer 渗透 |
| #9 | parallel processing | 2016 | ~2018（偏旧/蓝色） | 2016-2022 | **死亡** | 传统硬件聚类，MPY 偏旧，2022 后系统性退场 |

### MPY 指标解读

**平均出版年（MPY）** 是 CiteSpace 中每个聚类的节点颜色指标：红色=新（MPY 高），蓝色=旧（MPY 低）。

- **AI 聚类（#0/#1/#2/#3）MPY 均偏新（2022-2024）**，说明这些聚类由近期论文主导，是活跃前沿
- **传统硬件聚类（#4/#9）MPY 偏旧（2018）**，说明这些聚类由老论文支撑，已失去活力
- **#3 wafer map MPY 最新（~2024）**，说明晶圆图分析是当前最活跃的方向
- **MPY 与时间线判断一致**：MPY 新的聚类"活"，MPY 旧的聚类"死"
